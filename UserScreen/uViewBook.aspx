<%@ Page Title="View Books" Language="C#" MasterPageFile="~/UserScreen/User.Master" AutoEventWireup="true" CodeBehind="uViewBook.aspx.cs" Inherits="LibraryManagementSystemPT.UserScreen.uViewBook" %>
                            ...
                            <ItemTemplate>
                                <div class="container-fluid">
                                    <div class="row">
                                        <div class="col-lg-10">
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    ...
                                                    &nbsp;| Available Stock -
                                                            <asp:Label ID="Label11" runat="server" Font-Bold="True" Text='<%# Eval("currect_stock") %>'></asp:Label>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-12">
                                        ...
                                        <div class="col-lg-2">
                                            <asp:Image class="img-fluid" ID="Image2" runat="server" ImageUrl='<%# Eval("book_img_link") %>' />
                                        </div>
                                    </div>
                                </div>
                            </ItemTemplate>
