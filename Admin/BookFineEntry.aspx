<%@ Page Title="Book Fine" Language="C#" MasterPageFile="~/Admin/AdminSite.Master" AutoEventWireup="true" CodeBehind="BookFineEntry.aspx.cs" Inherits="LibraryManagementSystemPT.Admin.BookFineEntry" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container-fluid">
        <div class="row border align-content-center" id="A1" runat="server">
            Hi,
            <asp:Label ID="lblMembername" runat="server" Text="Label" ForeColor="Red" Font-Size="Large"> </asp:Label>
